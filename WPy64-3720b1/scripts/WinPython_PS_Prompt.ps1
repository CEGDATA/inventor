...
if (-not ($env:WINPYDIR -eq [System.IO.Path]::GetFullPath( $env:WINPYDIRBASE+"\python-3.7.2rc1.amd64")) ) {


$env:WINPYDIR = $env:WINPYDIRBASE+"\python-3.7.2rc1.amd64"


$env:WINPYVER = '3.7.2.0Ps2b1'
